...
Erik supplies photographs of the actual products as transparent-background PNG
cutouts. No stock photography is used anywhere on the site.

| Path | Subject | Status |
|---|---|---|
| `public/fleet/fjord.png` | Olive fleece, rolled and banded | Supplied |
| `public/fleet/aurora.png` | White fleece, rolled and banded | Awaiting supply |
| `public/korg.png` | White perforated carrier, bentwood handles | Supplied |
...
Until the white fleece photograph arrives, `aurora.png` is generated by
desaturating and lightening `fjord.png` so the layout is complete and the
